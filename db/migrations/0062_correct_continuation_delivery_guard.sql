-- Correct the two-beat guard to use the durable proactive work success state.
-- Migration 0061 used the continuation-run terminal name (`completed`) for a
-- proactive work row; proactive work rows instead terminate as `succeeded`.
