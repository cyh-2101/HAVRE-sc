"""Owner-run enrollment for an explicitly approved Windows activation bundle."""
...
from companion.life_context import WindowsContextActivationBundle
...
def main() -> None:
    ...
    bundle = WindowsContextActivationBundle.model_validate_json(
