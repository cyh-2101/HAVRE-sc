"""Report Stage 10 foreign keys without a matching left-prefix index."""
...
WITH wanted(table_name) AS (
  VALUES ('release_manifests'), ('release_approval_records'),
    ('deployments'), ('backup_manifests'), ('restore_erasure_replays')
), fk AS (
...
def audit_stage10_fk_indexes(database_url: str) -> list[dict[str, str]]:
...
def main() -> None:
    ...
    print(audit_stage10_fk_indexes(url))
